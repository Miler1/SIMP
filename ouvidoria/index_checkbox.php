...
<head>
    ...
    <script type="text/javascript" src="js/scripts_checkbox.js"></script>
...
<div class="container" id="conteudo">
    ...
    <div id="formcontato" class="card grey lighten-5 z-depth-4">
        ...
        <div class="card-content">
            <form id="form-ouvidoria" class="form-ouvidoria" >
                <div class="row">
                    <div class="col 12 red-text">* Campos obrigatórios</div>
                    <span id="camposErro"></span>
                </div>
                <div class="row">
                    <div class="col s12 sigilosa" id="divSigilosa">

                            <span>* Sua demanda é sigilosa:</span>
                            <input class="with-gap" name="sigilosa" type="radio" id="sigilosa1" value="Sim"/>
                ...
                <div class="row">
                    <div class="col s12 aviso-sigiloso" id="aviso-sigiloso">
                        <span><font color = "red">A solicitação de Sigilo garante a você que todas as informações apresentadas serão tratadas, em todo o processo, no mais absoluto sigilo em cumprimento ao disposto no Art. 6º do Regimento da Ouvidoria do UNILAVRAS. Em nenhum momento você será identificado junto aos setores institucionais. O preenchimento do campo nome, telefone e e-mail visa garantir a você uma resposta à questões apresentadas à Ouvidoria e um melhor acompanhamento do processo. Em hipótese alguma serão utilizadas estas informações na análise da demanda.</font></span>
                    </div>
                </div>

                <div class="row">
                    <div class="col s6 m3 l5 obj_reclamacao">
                    ...
                    <div class="col s6 m2 l5 meio_resposta" id="meio">
                    ...
                    <div class="col s12 m2 tipopessoa">
