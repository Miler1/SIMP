...
final class objeto_dao {
    ...
    //
        ...
        if (!isset($drivers[$this->bd_config['sgbd']])) {
            trigger_error('Erro no arquivo config.php ($bd_config->sgbd tem valor invalido)', E_USER_ERROR);
            exit(1);
        }
    ...
    public static function get_drivers() {
        ...
        if (extension_loaded('pgsql')) {
            ...
            $dados->codigo = 'pgsql';
            $dados->sgbd   = 'PostgreSQL';
            $dados->nome   = 'PostgreSQL Extension';
            $dados->porta  = '5432';
            $vt_driver[$dados->codigo] = $dados;
        }
