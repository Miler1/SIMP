...
class formulario {
    ...
    //
        ...
        // Armazenar dados do relacionamento e gerar chave
        $dados = serialize(array($classe, $campo_preencher, $campo_exibir, $condicoes));
        $id = md5($dados);
        util::criar_diretorio_recursos('simp_relacionamentos');
        file_put_contents($CFG->dirarquivos.'/simp_relacionamentos/'.$id, $dados);

        $link = FORMULARIO_WWWROOT.'webservice/relacionamento.xml.php?id='.$id;
