...
//
    ...
    if ($dados) {
        ...
        $logs = objeto::get_objeto('log_sistema')->consultar_varios_iterador($condicoes, true);
...
//
    ...
    $dados->de = formulario::filtrar('string', $dados->de);
    $dados->ate = formulario::filtrar('string', $dados->ate);
}
...
// iterador_dao $logs: resultado da consulta de logs
//
    global $CFG;
    $usuarios = array();
