...
// - montar_composta: monta uma condicao composta agrupando varias condicoes com operador AND ou OR
...
// Metodos que facilitam a criacao de alguns tipos de condicoes
...
// - montar_vetor: monta uma condicao composta de condicoes simples a partir de um vetor associativo
...
// Exemplo 4: Montando condicoes com um vetor associativo
$vt_valores = array(
    'cod_usuario' => '1',
    'login' => 'admin'
);
$condicoes = condicao_sql::montar_vetor($vt_valores, 'OR', '=');
$usuarios = objeto::get_objeto('usuario')->consultar_varios($condicoes, array('nome'));
imprimir_usuarios($usuarios);
